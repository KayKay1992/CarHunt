...
function HeroFilter() {
  ...
  return <div className="w-full flex flex-col gap-6 pt-6">
    ...
    <span className="flex items-center gap-1 font-light ">
        <b className="font-bold">1000+</b> CARS LISTED
    </span>
    <span className="flex items-center gap-1 uppercase font-semibold">Search Now <ChevronRight/> </span>
    </Button>
    <p className="text-muted-foreground text-sm text-center">Want to Search More Customized <Link href='/search' className="text-primary underline font-bold ml-2">Advanced Search</Link> </p>
  </div>;
}
